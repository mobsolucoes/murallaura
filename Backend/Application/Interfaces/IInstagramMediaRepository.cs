...
public interface IInstagramMediaRepository
{
    ...
    Task<IReadOnlyList<InstagramMediaPost>> ListByIdsAsync(IReadOnlyCollection<Guid> ids, CancellationToken ct);
    ...
    Task<int> DeleteManyAsync(IReadOnlyCollection<Guid> ids, CancellationToken ct);
